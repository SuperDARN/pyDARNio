...
"""
This file contains several exception classes used by the pyDARNio io borealis
module.
...
class BorealisVersionError(Exception):
    ...
    list of versions pyDARNio can read, which is found in the borealis_formats
    module.
