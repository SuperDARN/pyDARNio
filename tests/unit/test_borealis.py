...
class TestBorealisRead_v04(unittest.TestCase):
    ...
    def test_empty_file(self):
        ...
        self.assertRaises(OSError,
                          pydarnio.BorealisRead, self.empty_file_path, 'rawacf',
                          'site')
    ...
    def test_wrong_borealis_file_structure(self):
        ...
        self.assertRaises(wrong_file_structure_exceptions, pydarnio.BorealisRead,
...
if __name__ == '__main__':
    ...
    """
    pydarnio_logger.info("Starting Borealis unit testing on v0.5 files")
